...
def get_recomendations(token, limit = 1, artists=['None'], genres=['None'], tracks=['None']):
...
song = get_recomendations(request_auth(), artists=['Michael Jackson'], genres=['pop', 'rap'], tracks=['gods plan'])['tracks'][0]
print(song['name'])
